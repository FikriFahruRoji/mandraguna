    ...
    <div>
      ...
      <form @submit.prevent="submit" class="card" enctype="multipart/form-data">
        ...
        <div v-show="activeTab === 'ja'">
          <div class="form-group">
            <label class="form-label" for="title_ja">Judul Artikel (JA)</label>
            <input id="title_ja" type="text" class="form-input" v-model="form.title_ja" placeholder="Article Title in Japanese..." />
          ...
          <div class="form-group">
            ...
            <textarea id="excerpt_ja" class="form-input" v-model="form.excerpt_ja" rows="2" maxlength="500" placeholder="Brief summary of the article in Japanese..."></textarea>
          </div>

          <div class="form-group">
            <label class="form-label">Konten Artikel (JA)</label>
...
const form = useForm({
    ...
    title_ja: props.post?.title_ja || '',
    excerpt: props.post?.excerpt || '',
    excerpt_en: props.post?.excerpt_en || '',
    excerpt_ja: props.post?.excerpt_ja || '',
    content: props.post?.content || '',
    content_en: props.post?.content_en || '',
    content_ja: props.post?.content_ja || '',
    image: null,
