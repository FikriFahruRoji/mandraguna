    ...
    <aside class="sidebar" :class="{ collapsed: sidebarCollapsed }">
      ...
      <nav class="sidebar-nav">
        ...
        <div class="nav-item-group">
          <Link href="/panel-umkm/settings?group=general" class="nav-item" :class="{ active: isActive('/panel-umkm/settings') || isActive('/panel-umkm/change-password') }">
          ...
          <div v-if="(isActive('/panel-umkm/settings') || isActive('/panel-umkm/change-password')) && !sidebarCollapsed" class="nav-sub-items">
            ...
            <Link href="/panel-umkm/change-password" class="nav-sub-item" :class="{ active: isActive('/panel-umkm/change-password') }">
              Ganti Password
            </Link>
          </div>
        </div>
